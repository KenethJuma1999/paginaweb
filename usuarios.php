...
<head>
  ...
  <title>Usuarios - Flattern Bootstrap Template</title>
...
$sql="SELECT * FROM usuario WHERE cedulau='$cedulas'";
$consulta=mysql_query($sql,$conn);
$numfilas=mysql_num_rows($consulta);

if($numfilas==0){
$sql="INSERT INTO usuario VALUES ('$cedulas','$nombres','$direccions','$telefonos','$emails','$sexos','$fechans','$provincias')";
  ...
  <header id="header">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="index.html">Usuarios</a></h1>
      ...
      <form name="form1" method="post" action="">
        <table width="304" border="1" align="center">
          ...
          <tr>
            <td>&nbsp;</td>
            <td><label>
              <input name="btnEnviar" type="submit" id="btnEnviar" value="Registrar usuario">
            </label></td>
          </tr>
        </table>
      </form>
